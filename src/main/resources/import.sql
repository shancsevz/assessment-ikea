...
-- Sample product fulfillment data
INSERT INTO product_fulfillment(id, productId, warehouseBusinessUnitCode, storeId)
VALUES (1, 1, 'MWH.001', 1);
INSERT INTO product_fulfillment(id, productId, warehouseBusinessUnitCode, storeId)
VALUES (2, 1, 'MWH.012', 1);
INSERT INTO product_fulfillment(id, productId, warehouseBusinessUnitCode, storeId)
VALUES (3, 2, 'MWH.001', 2);
INSERT INTO product_fulfillment(id, productId, warehouseBusinessUnitCode, storeId)
VALUES (4, 2, 'MWH.023', 2);
ALTER SEQUENCE product_fulfillment_seq RESTART WITH 5;
